...
export const MemberManagement = ({ setActiveTab }) => {
  const { data, updateMemberStatus, removeMemberSafely, resetMemberPassword } = useData();
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-400">
            Account lifecycle management, unique PRN verification, password resets, and task safeguards
          </p>
        </div>
